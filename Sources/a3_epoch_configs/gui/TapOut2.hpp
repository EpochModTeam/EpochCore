class TapOut2 : TapOut
{
	...
	class controls
	{
		...
		{
			idc = 1601;
			action = "player setVariable ['EPOCH_doBoom',true];";
		...
		class morph: RscButton
		{
			idc = 1602;
			action = "player setVariable ['EPOCH_doMorph',true];";
			text = "Morph"; //--- ToDo: Localize;
