...
class UnderBarrelSlot;
    class a2_ak47s_gold_EPOCH_Base: Rifle_Base_F
	{
		...
		drySound[]={"\x\addons\a2_epoch_weapons_2\Sounds\dry", db-5, 1, 10};
    ...
    class a2_G36_C_epoch_base: Rifle_Base_F
	{
		...
		drySound[]={"\x\addons\a2_epoch_weapons_2\Sounds\G36_dry_v1", db-5, 1, 10};
		reloadMagazineSound[]={"A3\sounds_f\weapons\reloads\new_MX",db-8,1, 30};
        class GunParticles : GunParticles
		{
			class SecondEffect
	...
	class a2_m110_epoch_base: Rifle_Base_F
	{
		...
		UiPicture = "\x\addons\a2_epoch_weapons_2\UI\i_sniper_CA.paa";
        weaponInfoType = "RscWeaponZeroing";
		begin1[]={"\x\addons\a2_epoch_weapons_2\Sounds\M110_1", db5, 1,2000};
		drySound[]={"\x\addons\a2_epoch_weapons_2\Sounds\M110_dry",db0,1,20};
		reloadMagazineSound[]={"\x\addons\a2_epoch_weapons_2\Sounds\M110_reload",db0,1,100};
		reloadAction = "GestureReloadMX";
		magazineReloadSwitchPhase = 0.4;
	...
	class a2_svd_epoch_base: Rifle_Base_F
	{
		...
		aiDispersionCoefY=6.0;
		aiDispersionCoefX=4.0;
		drySound[]={"\x\addons\a2_epoch_weapons_2\Sounds\svd_dry_v1", db-5, 1, 10};
		reloadMagazineSound[]={"A3\sounds_f\weapons\reloads\new_MX",db-8,1, 30};
		selectionFireAnim = "muzzleFlash";
		maxZeroing = 1500;
